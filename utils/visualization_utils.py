...
#from Prediction import predictBottleClass
...
def draw_bounding_box_on_image(image,
    ...
    for display_str in display_str_list[::-1]:
        ...
        cropedImage = image.crop(
            (left - 50, (text_bottom - text_height - 2 * margin)-150, (left + text_width + 50), text_bottom + 400))
        cropedImage.save(
            os.getcwd() + '/Working_Directory/' + 'testImage' + '.jpeg',
            "JPEG",
            quality=80, optimize=True, progressive=True)
        #prediction=predictBottleClass(cropedImage)
        # prediction="perfect"
        # if prediction is 'defect' or  'with out cap':
        #     print('Writing image...')
        #     cropedImage.save(
        #         os.getcwd() + '\Testing_Directory\image' + str(int(datetime.datetime.now().timestamp())) + '.jpeg',
        #         "JPEG",
        #         quality=80, optimize=True, progressive=True)
        #
        # else:
        #     print("Perfect Bottle ")
